...
def fout = new PrintWriter(new BufferedWriter(new FileWriter("results/pmc-drugs-simple")))
...
fout = new PrintWriter(new BufferedWriter(new FileWriter("results/pmc-drugs-processed")))
