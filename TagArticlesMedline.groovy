...
PrintWriter fout = new PrintWriter(new BufferedWriter(new FileWriter("medline-tagged.txt")))
...
QueryParser parser = new QueryParser(Version.LUCENE_47, "abstract", analyzer)
